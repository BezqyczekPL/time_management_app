...
public class EdytujToDoList extends AppCompatActivity
{
    String data_dead;
    String godzina_dead;
    String email;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                time = extras.getString("deadline_time");
                date = extras.getString("deadline_day");
                ...
                godzina_dead=formatter1.format(date1);
                data_dead=formatter.format(date1);
                godzina_deadline.setText("Wybrana godzina: " + formatter1.format(date1) );
                data_deadline.setText("Wybrana data: " + formatter.format(date1));
                nazwa_wydarzenia.setText(title);
        ...
        dodaj_wydarzenie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (data_dead != null) {
                    ...
                    if (nazwa_wydarzenia.getText().toString().trim().length() > 0 && nazwa_wydarzenia.getText().toString().trim().length() <= 20) {
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                data[1] = "2022-10-10";
                                data[2] = "13:00:00";
                                PutData putData = new PutData("http://192.168.1.12/Projekt/updateToDo.php?id="+id+"&title="+nazwa_wydarzenia.getText().toString()+"&deadline_day="+data_dead+"&deadline_time="+godzina_dead, "POST", field, data);
                                if (putData.startPut()) {
                        ...
                        Toast.makeText(EdytujToDoList.this, "Nie dodałeś którejś z wartości lub któraś jest niepoprawna!", Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(EdytujToDoList.this, ToDoList.class);
                intent.putExtra("email", email);
                intent.putExtra("login", login);
                startActivity(intent);
                finish();
