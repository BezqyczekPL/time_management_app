...
public class DodajDoListy extends AppCompatActivity
{
    String email;
    String login;
    int user_id;
                        ...
                        public void run() {
                            ...
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    ...
                                    if (result.equals("Udalo sie dodac produkt do bazy danych")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(DodajDoListy.this, Lista.class);
                intent.putExtra("email", email);
                intent.putExtra("login", login);
                startActivity(intent);
                finish();
